...
import 'package:fe_football/app/data/dto/error_type.dart';
import 'package:fe_football/app/data/error/error_response.dart';
...
class FutureUtil {
  static FutureOrError<T> callOrError<T>(
    ...
    try {
      ...
      Log.debug('lagi error nih 2 respones :${e.response?.data}');
      switch (e.type) {
