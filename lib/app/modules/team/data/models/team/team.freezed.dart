...
class _$TeamImpl implements _Team {
  const _$TeamImpl({
    ...
    required this.name,
    required this.logo,
    @JsonKey(name: 'established_year') required this.establishedYear,
  ...
  @override
  String toString() {
    return 'Team(id: $id, name: $name, logo: $logo, establishedYear: $establishedYear, address: $address, city: $city, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Team implements Team {
  const factory _Team({
    ...
    @JsonKey(name: 'established_year') required final int establishedYear,
